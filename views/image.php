<div class="container">
	...
	<table class="table table-bordered table-striped mt-4">
        ...
        for ($index=0; $index < $length; $index++) { 
            ...
            echo "<input type='hidden' value='". $image['image']."' name='image' />";
            echo "<tr>";
            echo "<td>".$image['designation'] . "</td>";
            echo "<td><button type='submit' class='btn btn-danger'>Supprimer</button>";
            echo "</form>";
            echo "<td><a href='./monReseau/".$image['idimage']."' class='btn btn-info'>Modifier</a></td>";
            echo "</tr>";
        }
        ?>
    </table>
