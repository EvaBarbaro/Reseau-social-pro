...
<nav class="navbar navbar-expand-lg navbar-light bg-light mb-6">
  ...
  <a class="navbar-brand" href="<?php echo pathUrl().'monReseau/'.$_SESSION['identreprise'].'/reseau/publications'?>"><img 
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item home">
        <a class="nav-link" href="<?php echo pathUrl().'monReseau/'.$_SESSION['identreprise'].'/reseau/publications'?>">Accueil</a>
      </li>
